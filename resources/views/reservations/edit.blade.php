...
<form action="{{ route('reservations.update', $reservation->id) }}" method="POST">
    ...
    <div class="form-group">
        ...
        <input type="date" class="form-control" id="check_in" name="check_in" value="{{ $reservation->check_in }}" required>
    </div>

    <div class="form-group">
        <label for="check_out">Check-out:</label>
        <input type="date" class="form-control" id="check_out" name="check_out" value="{{ $reservation->check_out }}" required>
    </div>

    <div class="form-group">
        <label for="nomor">Nomor Reservasi:</label>
        <input type="text" class="form-control" id="nomor" name="nomor" value="{{ $reservation->nomor }}" required>
    </div>
    
    <div class="form-group">
        <label for="telp">Telpon:</label>
        <input type="text" class="form-control" id="telp" name="telp" value="{{ $reservation->telp }}" required>
    </div>
